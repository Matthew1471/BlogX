...
'--- Open set ---'
Records.Open "SELECT Content, Des1, Des2, Des3, Des4 FROM Poll ORDER By PollID DESC",Database, 1, 3
...
<input Name="Action" type="hidden" Value="Post">
		...
		<% End If %>
            ...
            <tr>
            <td colspan="2">
            <textarea Name="Content" DESIGNTIMEDRAGDROP="96" style="height:5em;width:100%;" onChange="return setVarChange()"><%=Content%></textarea>
            </tr>
			</table>
            </P>

            <P>Option1 : <input Name="Option1" type="text" style="width:10%;" maxlength="50" value="<%=Des1%>"><br>
            Option2 : <input Name="Option2" type="text" style="width:10%;" maxlength="50" value="<%=Des2%>"><br>
            Option3<font color="Red">*</Font> : <input Name="Option3" type="text" style="width:10%;" maxlength="50" value="<%=Des3%>"><br>
            Option4<font color="Red">*</Font> : <input Name="Option4" type="text" style="width:10%;" maxlength="50" value="<%=Des4%>"></P>
...
Records.LockType = 3
Records.Open "SELECT PollID, Content, Des1, Des2, Des3, Des4 FROM Poll ORDER By PollID DESC", Database

...
<Center>
<%
Dim Count, Upload, DIR, File, EXT, Something
...
If Ext = "JPG" or Ext = "GIF" or Ext = "PNG" or Ext = "BMP" Then
  Dim Thumbnails
  If Upload.FileExists(Server.MapPath("Images\Articles\") & "\" & Requested & "\Thumbnails\tn" & File.FileName) Then Thumbnails = "Thumbnails/tn"
Something = True
Count = Count + 1
Do While Count > 7
Response.Write "<TR>"
...
Loop
%>
   <TD><img width="50" height="50" src="Images/Articles/<%=Requested & "/" & Thumbnails & File.FileName%>"><br>

...
Dim SiteURL, LinksPath, Version, RSS
...
AllowEditingLinks = 1	  'Setting to 1 allows a logged in user to edit the links file online
...
Register = False	  'Notifies BlogX.co.uk That You want Your Site Addded To OtherLinks.txt
...
'***********************************************'
	...
	Copyright       = "Content © 2004 Matthew Roberts"
...
If Len(CStr(Source)) > 0 Then Response.Write "<b>Error Source : </b> " & Source & "<br><br>" 
...
If Len(CStr(RequestedQuerystring)) > 0 Then Response.Write "<b>Query : </b> " & RequestedQuerystring
%>
</P>
...
If FSO.FileExists(LinksPath) Then
	...
	Do While Not TextStream.AtEndOfStream
		If TextStream.Readline = "*" Then
                ...
                Response.Write "<Li><a href=""" & URL & """>" & Name & "</a></Li><br>"
                End If
	Loop
        Else
...
If FSO.FileExists(OtherLinksPath) Then
	...
	Do While Not TextStream.AtEndOfStream
		If TextStream.Readline = "*" Then
                Name = TextStream.Readline
                URL = TextStream.Readline
                Response.Write "<Li><a href=""" & URL & """ Target=""_New"">" & Name & "</a></Li><br>"
                End If
	Loop
        Else
        Response.Write "<Li>No Links (File Broken)</Li>"
...
<DIV class=section>
<H3>Poll</H3>
 <UL>Not Available In "Safe Mode"</UL></DIV><BR>
 <% End If %>
...
<H3>Categories</H3>
<UL>
<Li>Not Available In "Safe Mode"</Li>
</UL></DIV><BR>
<%End If
If (LegacyMode <> True) Then %>
<!--- Search Blog --->
...
<P id=poweredBy>Powered by <A href="<% If AboutPage = True Then Response.Write SiteURL & "About.asp" Else Response.Write "http://blogX.co.uk/Blog/About.asp"%>"><acronym title="Powered By: Matthew1471 BlogX Version V<%=Version%>">Matthew1471's edition of BlogX</acronym></A></P></DIV>
...
Dim ToName, ToEmail, From, Subject, Body, iConf, Flds, Mail, MailBody, Err_Msg
...
If Len(CStr(RequestedQuerystring)) > 0 Then MailBody = MailBody &  "<b>Query : </b> " & RequestedQuerystring

...
%>
		...
		Content : <input type="text" name="Content"/><br/>
                <% If ShowCat <> False Then Response.Write "Category : <input type=""text"" name=""Category""/><br/>"%>
		...
		<postfield name="Content" value="$(Content)"/>
                <% If ShowCat <> False Then Response.Write "<postfield name=""Category"" value=""$(Category)""/>"%>
		</go>
		</anchor>
<%
Else

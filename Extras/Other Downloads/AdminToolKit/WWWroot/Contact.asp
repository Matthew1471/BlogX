...
<% Dim TheAt, TheDot, Mailbuddy, Subject, iConf, Message, flds, Mail%>
      <td width="934" bgcolor="#1843C4" height="28"><b><font color="#FFFFFF" face="Verdana" size="2">Contact The Webmaster Of <%=Domain%></font></b></td>
    ...
    <tr>
      ...
      Please if you have a complaint to make, provide a <b>valid</b> e-mail address so we may reply back to you.<P>
      </font>
...
<input type="hidden" name="To" value="<%If Request.Querystring("To") <> "" Then Response.Write Request.Querystring("To") Else Response.Write "Webmaster"%>">
  <table border="1" cellpadding="0" cellspacing="0" width="1%" height="205" bordercolordark="#000000" bordercolorlight="#000000">
    ...
    <tr>
      ...
      <td width="80%" bgcolor="#666699" height="21"><input type="text" name="Subject" size="20" Value="<%=Request.Querystring("Subject")%>"></td>
    </tr>
    <tr>
...
Response.Write "<a href=""contact.asp"">Back</a></center>"
%>
	  </td>
          <%
WriteFooter
...
MailBuddy = Request.Form("To") & "@matthew1471.co.uk"  
...
'--- End Of Test For @ ---'
			...
			Subject = "Matthew1471 Site : " & Subject

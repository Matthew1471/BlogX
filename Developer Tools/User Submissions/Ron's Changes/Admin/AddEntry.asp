		...
		<% End If %>
			...
			Do Until (Records.EOF or Records.BOF)
				If (LastCat <> Category) OR (IsNull(LastCat) = True) AND (Category <> "") Then
					if Replace(Category, "%20", " ")=Replace(request.querystring("addCat"), "%20", " ") then
			...
			Response.Write " or create/edit the selected Category : <input Name=""Category"" Value="""&  Replace(request.querystring("addCat"), "%20", " ") &""" type=""text"" style=""width:10%;"" maxlength=""50""></P>"

...
on error resume next
	...
	paramList(0)="http://matthew1471.co.uk/Wordpress/index.php?p=12"
	paramList(1)="http://matthew1471.co.uk/Blog/ViewItem.asp?Entry=210"

	Response.write("<pre>" & Replace(functionToXML("pingback.ping", paramList), "<", "&lt;", 1, -1, 1) & "</pre>")
	myresp = xmlRPC ("http://BlogX.co.uk/Blog/RSS/Pingback/Default.asp", "pingback.ping", paramList)

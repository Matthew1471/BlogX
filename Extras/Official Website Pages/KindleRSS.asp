...
<%
' --------------------------------------------------------------------------
'¦Introduction : Kindle RSS Feed.                                           ¦
'¦Purpose      : This provides an RSS feed specifically excluding entries   ¦
'¦               that are not stored in the "Android", "Computing"          ¦
'¦               and "Shopping" as professionals are not interested in them.¦
'¦Used By      : Amazon Kindle Publisher Platform.                          ¦
'¦Requires     : Includes/Config.asp, Includes/RSSReplace.asp,              ¦
'¦               Includes/Cache.asp.                                        ¦
'¦Ensures      : Professional readers are not bored, contains full content. ¦
'¦Standards    : RSS 0.92.                                                  ¦
'---------------------------------------------------------------------------
...
Records.Open "SELECT RecordID, Title, Text, Category, Password, Day, Month, Year, Time, UTCTimeZoneOffset, Enclosure, LastModified FROM Data WHERE Category IN ('Android','Computing','Shopping') ORDER BY RecordID DESC",Database, 1, 1

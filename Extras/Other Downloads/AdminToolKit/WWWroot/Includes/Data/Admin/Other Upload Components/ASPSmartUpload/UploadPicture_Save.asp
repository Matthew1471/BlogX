...
End If
   ...
   Set Upload = Server.CreateObject("aspSmartUpload.SmartUpload")
       Upload.AllowedFilesList = "jpg,gif,bmp,png"
   ...
   For Counter = 1 To Upload.Files.Count
     ...
     Upload.Files.Item(Counter).SaveAs Server.MapPath("..\Images\Articles") & "\" & Filename
     Count = Count + 1
     End If
   Next
...
Else
Response.Write "<p align=""center"">Error : This Page Requires<br> <a href=""http://www.aspsmart.com/aspSmartUpload/"">ASPSmart Upload</a></p>"
End If
End If
%>
</font></p>

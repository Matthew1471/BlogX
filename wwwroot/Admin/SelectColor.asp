<%
' --------------------------------------------------------------------------
'¦Introduction : Color Chooser Page.                                        ¦
'¦Purpose      : Provides selectable sample colors that may populate a form.¦
'¦Used By      : Admin/Config.asp.                                          ¦
'¦Requires     : Nothing.                                                   ¦
'¦Notes        : This page is used in the config (as a popup) for           ¦
'¦               stylesheets that do not already specify a colour.          ¦
'¦Standards    : Almost HTML 4 Transitional (some non-standard colors used.)¦
'---------------------------------------------------------------------------
 ...
 <TR>
  <TD>
   <TABLE border="0" cellspacing="1" cellpadding="1">
    ...
    <TR>
     <TD colspan="16">
      <p>Click on the color you want.<br>&nbsp;
     </TD>
    </TR>
    <TR>
     <TD colspan="16">
      <b>Named Colors - Basic</b>
     </TD>
    </TR>
    <TR>
<%
	...
	ShowColorBox "fuchsia"
       ...
       If ColumnCount < 16 Then Response.Write "    <TD colspan=""" & (16-ColumnCount) & """></TD>"
%>
    </TR>
    <TR>
     <TD colspan="16">
      <B>Named Colors - Additional</B>
     </TD>
    </TR>
    <TR>
<%
